...
import com.ganshujin.androidrealtimelocation.ViewHolder.FriendRequestViewHolder;
...
public class FriendRequestActivity extends AppCompatActivity implements IFirebaseLoadDone {
    ...
    private void startSearch(String search_value) {
        ...
        searchAdapter = new FirebaseRecyclerAdapter<User, FriendRequestViewHolder>(options) {
            ...
            @Override
            protected void onBindViewHolder(@NonNull FriendRequestViewHolder friendRequestViewHolder, int i, @NonNull final User model) {
                friendRequestViewHolder.txt_user_email.setText(model.getEmail());
